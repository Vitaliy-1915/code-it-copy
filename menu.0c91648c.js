...
(function () {
  var menuBtnOpen = document.querySelector("[data-menu-button-open]");
  var menuBtnClose = document.querySelector("[data-menu-button-close]");
  var itemClose = document.querySelectorAll("[close-menu]");
  var mobileMenuRef = document.querySelector("[data-menu-mobile]");
  var tabletMenuRef = document.querySelector("[data-menu-tablet]"); // MOBILE and TABLET Menu Open
